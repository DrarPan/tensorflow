...
if __name__=="__main__":
	dataSet = Dataset("./image/trainingdata/",Ntrainingset=500,Ntestingset=100,shuffle=True)
	np.savetxt("./data/map_extrainingset_image_528.txt",dataSet.trainingSet[0])
	np.savetxt("./data/map_extrainingset_label_528.txt",dataSet.trainingSet[1],fmt="%d")
	np.savetxt("./data/map_extestingset_image_528.txt",dataSet.testingSet[0])
	np.savetxt("./data/map_extestingset_label_528.txt",dataSet.testingSet[1],fmt="%d")
